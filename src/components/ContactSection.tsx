...
const socials = [
  { label: "Instagram", icon: InstagramIcon, href: "https://www.instagram.com/foodieez_junction_01/?hl=en", hoverClass: "hover:bg-pink-500/10 hover:border-pink-500/30 hover:text-pink-400" },
  { label: "Facebook",  icon: FacebookIcon,  href: "https://www.facebook.com/foodieezjunction",  hoverClass: "hover:bg-blue-500/10 hover:border-blue-500/30 hover:text-blue-400" },
];
    ...
    <div className="max-w-3xl mx-auto px-4 relative z-10">
      ...
      >
        ...
        <p className="text-muted-foreground font-body text-sm max-w-xs mx-auto mb-10 leading-relaxed">
          Order via WhatsApp or follow us on social for daily specials.
        </p>
            ...
            return (
              <motion.a
                ...
                className={`w-14 h-14 rounded-2xl glass flex items-center justify-center
                            text-foreground/40 transition-all duration-250 ${s.hoverClass}`}
              >
                <Icon />
              </motion.a>
            );
