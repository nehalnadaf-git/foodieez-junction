...
export function AvailabilityManager() {
  ...
  return (
    <div className="relative pb-32 max-w-[1200px] mx-auto min-h-screen">
      ...
      >
        <div className="mb-8">
          <h2 className="bg-gradient-to-r from-[#F5A623] to-[#C47B05] bg-clip-text text-3xl md:text-4xl font-display font-bold text-transparent tracking-tight">
            Availability Manager
          </h2>
          <p className="mt-2 text-white/60 text-sm md:text-base max-w-xl leading-relaxed">
      ...
      <AlertDialog.Root open={!!pendingRoute} onOpenChange={(open) => !open && setPendingRoute(null)}>
        <AlertDialog.Portal>
          ...
          <AlertDialog.Content className="fixed left-[50%] top-[50%] z-[100] w-full max-w-lg translate-x-[-50%] translate-y-[-50%] rounded-[24px] border border-white/10 bg-[hsl(20,18%,8%)] p-6 md:p-8 shadow-2xl duration-200">
            ...
            <div className="mt-8 gap-3 flex flex-col md:flex-row justify-end">
              <AlertDialog.Cancel asChild>
                <button 
                  ...
                  className="px-5 py-2.5 rounded-xl text-sm font-semibold border border-[#FBA919] text-[#FBA919] hover:bg-[#FBA919]/10 transition-colors"
                >
                  Stay
                </button>
              </AlertDialog.Cancel>
              <AlertDialog.Action asChild>
                <button
                  ...
                  className="px-5 py-2.5 rounded-xl text-sm font-semibold border border-transparent bg-red-500/10 text-red-500 hover:bg-red-500/20 transition-all font-bold"
                >
